...
## [11.13.0](https://github.com/bassamsdata/codecompanion.nvim/compare/v11.25.0...v11.13.0) (2025-02-03)
...
* :sparkles: `CodeCompanionCmd` to write command-line commands ([da52e53](https://github.com/bassamsdata/codecompanion.nvim/commit/da52e53bcc69fb00c28e19edce61f927af2e683d))
...
* [#604](https://github.com/bassamsdata/codecompanion.nvim/issues/604) `send_code` can be a function ([30b899e](https://github.com/bassamsdata/codecompanion.nvim/commit/30b899e638d5525494b64eacd19b1c0eb50f988c))
* /buffer slash command can select multiple buffers ([e88b703](https://github.com/bassamsdata/codecompanion.nvim/commit/e88b7036a6428ce82b7254b0a2d58ae869635bbd))
* **adapters:** ✨ add Azure OpenAI ([#386](https://github.com/bassamsdata/codecompanion.nvim/issues/386)) ([542628d](https://github.com/bassamsdata/codecompanion.nvim/commit/542628dd68e26bbb59699aa48fe98b83a3798999))
* **adapters:** add DeepSeek Adapter ([#683](https://github.com/bassamsdata/codecompanion.nvim/issues/683)) ([6668b5c](https://github.com/bassamsdata/codecompanion.nvim/commit/6668b5c517978207a7b00f3f5a9bc8c7760ebcad))
* **adapters:** add Hugging Face adapter ([#527](https://github.com/bassamsdata/codecompanion.nvim/issues/527)) ([48747c4](https://github.com/bassamsdata/codecompanion.nvim/commit/48747c4e36eb0a3f44d6d9e55f8089b9e27cacfc))
...
* **adapters:** allow for o1 models at some point with improved schema ([601fa72](https://github.com/bassamsdata/codecompanion.nvim/commit/601fa72b09327f57e0703539673ef120ba3f420c))
* **adapters:** update `copilot` and `openai` adapters for o1 models ([c7ba92a](https://github.com/bassamsdata/codecompanion.nvim/commit/c7ba92ad367939e94bfa23df7e3eb1bc74909348))
* **adapters:** update the new haiku model ([#404](https://github.com/bassamsdata/codecompanion.nvim/issues/404)) ([9b00ed3](https://github.com/bassamsdata/codecompanion.nvim/commit/9b00ed39c11f43fbb829bcbada2f0a7105dfcee6))
* add language configuration for LLM responses ([#410](https://github.com/bassamsdata/codecompanion.nvim/issues/410)) ([e1a39bb](https://github.com/bassamsdata/codecompanion.nvim/commit/e1a39bb4e19cbda955a0f3caf09b78b798d10c4c))
* add native completions ([a1147f8](https://github.com/bassamsdata/codecompanion.nvim/commit/a1147f8133707251603525acf6a87f5c12ef3a70))
* add new events ([9b85331](https://github.com/bassamsdata/codecompanion.nvim/commit/9b8533143e381fb0dd4e5c733217dac8f9852ea4))
...
* **chat:** :sparkles: `blink.cmp` support ([cb2c93f](https://github.com/bassamsdata/codecompanion.nvim/commit/cb2c93f8a6b0ab0522a814f244b8011a7275ea3b))
* **chat:** :sparkles: can pin buffers and files to requests ([fc8ee3a](https://github.com/bassamsdata/codecompanion.nvim/commit/fc8ee3a085a44d0ef0111be0499f6552d7dbe865))
* **chat:** :sparkles: can watch buffers ([176c13e](https://github.com/bassamsdata/codecompanion.nvim/commit/176c13e227cf39c4e22bec68d4631a8c47b643de))
...
* **chat:** add `CodeCompanionChatOpened` event ([fdfc640](https://github.com/bassamsdata/codecompanion.nvim/commit/fdfc640f638de7e44580c75882b81cc6dd99b950))
* **chat:** adding to chat initializes buffer if needed ([#567](https://github.com/bassamsdata/codecompanion.nvim/issues/567)) ([8c82ced](https://github.com/bassamsdata/codecompanion.nvim/commit/8c82cedc3d70255ec6ea0fdb348b3e931c435fba))
* **chat:** can delete references ([367eccc](https://github.com/bassamsdata/codecompanion.nvim/commit/367eccc7cc57edcc249bae850ac4ccdf599a060c))
* **chat:** can delete references ([c0b8c25](https://github.com/bassamsdata/codecompanion.nvim/commit/c0b8c2522c20b8369201132a4ce953f3cdf7b5e2))
* **chat:** customize split position ([#556](https://github.com/bassamsdata/codecompanion.nvim/issues/556)) ([7374192](https://github.com/bassamsdata/codecompanion.nvim/commit/73741920097f36c762bb8fe1f4de6617389e2d4c))
* **chat:** display references which are shared with the LLM in the UI ([767efee](https://github.com/bassamsdata/codecompanion.nvim/commit/767efee2ff8fd7d84ac9a5ff35bac52eecec5584))
* **chat:** keymaps can be custom functions ([5f729f9](https://github.com/bassamsdata/codecompanion.nvim/commit/5f729f91a6b6a4025f8e4753d2c2c29810da0149))
* **chat:** tools and variables are now added to references ([a291a05](https://github.com/bassamsdata/codecompanion.nvim/commit/a291a05233f8ecf7b86a163dcd8bd349f319ff43))
...
* **completion:** auto setup blink.cmp ([90a6603](https://github.com/bassamsdata/codecompanion.nvim/commit/90a66033ffddb2f1daac0e5d23723214673ab0e5))
* **completion:** suggestions in blink have better score ([4317513](https://github.com/bassamsdata/codecompanion.nvim/commit/4317513cdb5fb7f35147448e3ca696756bf82cf2))
...
* **copilot:** add token count ([4fd26a6](https://github.com/bassamsdata/codecompanion.nvim/commit/4fd26a6fd9bc6aa4e88176350a05ff7e16b3a789))
* **copilot:** now working with o1 models ([7283611](https://github.com/bassamsdata/codecompanion.nvim/commit/72836115615b62065507431b8a9a8523d224f8e4))
...
* **event:** add `CodeCompanionChatPin` event ([f86f4a7](https://github.com/bassamsdata/codecompanion.nvim/commit/f86f4a72dd154bb677d117e06cab9a9ee8d35f56))
...
* **keymaps:** add condition logic ([c4eb21e](https://github.com/bassamsdata/codecompanion.nvim/commit/c4eb21e89ecf466416b75395ac00bf3db83838e7))
* mini_pick can select multiple buffers ([#413](https://github.com/bassamsdata/codecompanion.nvim/issues/413)) ([031a9e9](https://github.com/bassamsdata/codecompanion.nvim/commit/031a9e9d253872308d22c6619fa7e7db62ba7fc7))
* **mini_pick:** allow multi selection in /files ([#444](https://github.com/bassamsdata/codecompanion.nvim/issues/444)) ([68e0610](https://github.com/bassamsdata/codecompanion.nvim/commit/68e0610fa847ad818f621006746ff4a5f911371f))
* **openai:** support for o1 models ([6f98005](https://github.com/bassamsdata/codecompanion.nvim/commit/6f980055b49d1c96af1c63943152147b4f303ab8))
* **prompts:** :sparkles: can now add references to the prompt library ([d5d86c9](https://github.com/bassamsdata/codecompanion.nvim/commit/d5d86c9af92555d2cafcb147573871445b8688b5))
* **prompts:** system prompt is optional for custom prompts ([90820fc](https://github.com/bassamsdata/codecompanion.nvim/commit/90820fcdb5e6a570dc4f92731fade4d5f716ea02))
* register source for filetype in blink.cmp ([#661](https://github.com/bassamsdata/codecompanion.nvim/issues/661)) ([2214916](https://github.com/bassamsdata/codecompanion.nvim/commit/2214916416dcf18741c65fe3afd034d0fe046263))
* **slash_cmd:** notify if no terminal buffer is found ([3687b88](https://github.com/bassamsdata/codecompanion.nvim/commit/3687b8807746700851f13a373ad6ead04bb082bd))
* **slash_cmds:** `buffer` slash command now sends line numbers ([25dab99](https://github.com/bassamsdata/codecompanion.nvim/commit/25dab9939e5065a59207d3b77eefc63e4b6e9fc0))
...
* **slash_commands:** `help` cmd now prompts user to trim if exceeding max_lines ([33c326a](https://github.com/bassamsdata/codecompanion.nvim/commit/33c326a0d31473ecf3112d783dbcc22afccfb801))
* **slash_commands:** help can now select multiple docs ([57e8e54](https://github.com/bassamsdata/codecompanion.nvim/commit/57e8e54df850749eb98001f52af5bc4f60b79f0e))
* **tools:** `[@files](https://github.com/files)` tool can now read specific lines ([26c5b57](https://github.com/bassamsdata/codecompanion.nvim/commit/26c5b57aa80cb7a12baefa5a5a2e9cfe0a20126a))
* **tools:** `files` tool now uses search/replace block to edit text ([a02f6c7](https://github.com/bassamsdata/codecompanion.nvim/commit/a02f6c7bcbfdf955ca1c603b635cd9bc5baaaa7c))
...
* [#423](https://github.com/bassamsdata/codecompanion.nvim/issues/423) diff provider and `before` inline prompt ([f9a54cc](https://github.com/bassamsdata/codecompanion.nvim/commit/f9a54cc28a861770c3b3db787353b24e7fd0cd2d))
* [#427](https://github.com/bassamsdata/codecompanion.nvim/issues/427) long prompts causing issue with curl ([d5bef40](https://github.com/bassamsdata/codecompanion.nvim/commit/d5bef403460908069810726ffe79039d4c69f054))
* [#435](https://github.com/bassamsdata/codecompanion.nvim/issues/435) navigate chat buffers ([5779868](https://github.com/bassamsdata/codecompanion.nvim/commit/5779868e2db9fd056c835f375a57287bf46444f0))
* [#501](https://github.com/bassamsdata/codecompanion.nvim/issues/501) `blink.compat` causing issues with completion menu ([c5065d0](https://github.com/bassamsdata/codecompanion.nvim/commit/c5065d02916d8c1bf5dd3baf9f0dd5e1f017fd57))
* [#542](https://github.com/bassamsdata/codecompanion.nvim/issues/542) use vim.treesitter instead of nvim-treesitter. ([#543](https://github.com/bassamsdata/codecompanion.nvim/issues/543)) ([b741490](https://github.com/bassamsdata/codecompanion.nvim/commit/b741490066c0129554300e493f27767b760ffa16))
...
* **adapters:** [#528](https://github.com/bassamsdata/codecompanion.nvim/issues/528) Gemini adapter fails if system prompt is removed ([7ca4364](https://github.com/bassamsdata/codecompanion.nvim/commit/7ca43642376d7768a3f2ecea2cd99ae9a792451a))
* **adapters:** [#560](https://github.com/bassamsdata/codecompanion.nvim/issues/560) nil url in openai_compatible adpater ([5cc2693](https://github.com/bassamsdata/codecompanion.nvim/commit/5cc26934b0732dda03d311195e6d3f357e4f4a0c))
* **adapters:** azure_openai deployment model mapping ([907e47a](https://github.com/bassamsdata/codecompanion.nvim/commit/907e47ac490a9ab91be8db820e99be6845e0cdc5))
* **adapters:** further openai_compatible fixes ([a84f6ff](https://github.com/bassamsdata/codecompanion.nvim/commit/a84f6ff4be745bcff7d69af96fdbdae2465a33a2))
* **adapters:** gemini-2.0-flash-exp inline strategy ([#568](https://github.com/bassamsdata/codecompanion.nvim/issues/568)) ([a9faa69](https://github.com/bassamsdata/codecompanion.nvim/commit/a9faa69d3bf8308b78deab97292af2acc57d2f87))
...
* **adapters:** openai_compatible ([0d1388f](https://github.com/bassamsdata/codecompanion.nvim/commit/0d1388f7409f06e96ef2a7eadfa76c1dcfb74648))
* allow for multiple completions in a single line ([3516e46](https://github.com/bassamsdata/codecompanion.nvim/commit/3516e46a62ebb151e6fa0afe4ac631432994cc3a))
* **blink:** [#587](https://github.com/bassamsdata/codecompanion.nvim/issues/587) slash commands ([1b8ab18](https://github.com/bassamsdata/codecompanion.nvim/commit/1b8ab18cd0be76f13d13e6deaa56e6c33dce5a23))
* **blink:** slash commands leaving brackes in chat buffer ([820bc52](https://github.com/bassamsdata/codecompanion.nvim/commit/820bc52c7b4a5a494773a3aa4e25e9e36659e378))
* cancel requests to llm ([3a69421](https://github.com/bassamsdata/codecompanion.nvim/commit/3a694217ec868a8551fb6ec3203b98dad11888c9))
* **chat:** [#447](https://github.com/bassamsdata/codecompanion.nvim/issues/447) moving between windows ([d3e88dd](https://github.com/bassamsdata/codecompanion.nvim/commit/d3e88dd8f66bf746d361c8ba96e862d4e3e4aa0f))
* **chat:** [#450](https://github.com/bassamsdata/codecompanion.nvim/issues/450) no longer remove autocmds ([ca1e4d8](https://github.com/bassamsdata/codecompanion.nvim/commit/ca1e4d837d224fc879e031fcea4613c29fade1c0))
* **chat:** [#622](https://github.com/bassamsdata/codecompanion.nvim/issues/622) parse messages when `show_header_separator` is on ([6040ce4](https://github.com/bassamsdata/codecompanion.nvim/commit/6040ce4b45e0b9378e4c51c2d86cf5f40b2af2c5))
...
* **chat:** agent's tools are no displayed individually ([d889210](https://github.com/bassamsdata/codecompanion.nvim/commit/d889210fd2c536940fb57ec0ad90d018e76c275c))
* **chat:** always strip references from messages ([4c91a46](https://github.com/bassamsdata/codecompanion.nvim/commit/4c91a46136b6db99880c694313c9cabee24bd715))
...
* **chat:** changing adapter in empty chat w/o system prompt ([#616](https://github.com/bassamsdata/codecompanion.nvim/issues/616)) ([3e64e6c](https://github.com/bassamsdata/codecompanion.nvim/commit/3e64e6c89af1c3e841bbd59b67265f475983c164))
* **chat:** changing adapters for models with table type ([3a961bb](https://github.com/bassamsdata/codecompanion.nvim/commit/3a961bb2df0dd9245bdf2c9cc2e3fcdb7d9f3654))
* **chat:** changing model always changes settings ([318f40d](https://github.com/bassamsdata/codecompanion.nvim/commit/318f40d35bb53d663f8f80f26737b69430fe1c55))
* **chat:** clear references table ([7c0f6fb](https://github.com/bassamsdata/codecompanion.nvim/commit/7c0f6fb1687c4499075d02913e308279cfeb1b2a))
* **chat:** display tokens in chat buffer ([de55dd5](https://github.com/bassamsdata/codecompanion.nvim/commit/de55dd5c270e486cebf2d11861da41d816926051))
...
* **chat:** prevent double adding of references ([953b20d](https://github.com/bassamsdata/codecompanion.nvim/commit/953b20dabf63e4e5c7b30b9d32cd1136291aceb1))
* **chat:** show documentation for blink.cmp ([f41dbab](https://github.com/bassamsdata/codecompanion.nvim/commit/f41dbab850572b290e37e0b52244b8ccb9699870))
* **chat:** slash commands from prompt library not visible ([3376f60](https://github.com/bassamsdata/codecompanion.nvim/commit/3376f6052217737cb936236d9069bd4a63ccbace))
* **cmd:** strategy now respects `vim.g.codecompanion_adapter` ([b629005](https://github.com/bassamsdata/codecompanion.nvim/commit/b629005f0467471b4439192492cea2d49f22d52f))
* **cmd:** users can now change adapters ([ec2e4df](https://github.com/bassamsdata/codecompanion.nvim/commit/ec2e4dfedbaf35fa79f03d9f73c4cf4089425359))
* **cmp:** extend default sources ([8b0ebb4](https://github.com/bassamsdata/codecompanion.nvim/commit/8b0ebb4092c3266746663443d1b8dff13e3ba723))
* **completion:** [#597](https://github.com/bassamsdata/codecompanion.nvim/issues/597) blink configuration ([a1166d5](https://github.com/bassamsdata/codecompanion.nvim/commit/a1166d5a2e9249f81060d328859382be57eae79d))
* **completion:** blink.cmp failing for slash commands ([6dd3309](https://github.com/bassamsdata/codecompanion.nvim/commit/6dd3309e6761d7ae8cbda386781eb48354f00db2))
* **completion:** setting of keymaps ([03fbb0a](https://github.com/bassamsdata/codecompanion.nvim/commit/03fbb0ac20d3a028d9462efe49f3d53b60e92a8a))
* **config:** wrap completion condition in pcall ([d19ae05](https://github.com/bassamsdata/codecompanion.nvim/commit/d19ae05f561a7d3b5d311453285996e84cc925de))
* **copilot:** make gpt-4o the default again ([28e8ddc](https://github.com/bassamsdata/codecompanion.nvim/commit/28e8ddc97e0044e5f04ddd261ac6fa06da9deca6))
* **copilot:** show token output in chat ([6908fd7](https://github.com/bassamsdata/codecompanion.nvim/commit/6908fd71b589c9a4813f2dad9f460a6368003617))
...
* **diff:** is_visible() a nil value in default diff ([8d7a796](https://github.com/bassamsdata/codecompanion.nvim/commit/8d7a7965095925039dbfe34f56b0d72920e67545))
* **gemini:** remove cycle from system prompt ([d6b95bb](https://github.com/bassamsdata/codecompanion.nvim/commit/d6b95bb6cbf074e2e431c6a7f9acdd1af7cc9397))
* **inline:** [#426](https://github.com/bassamsdata/codecompanion.nvim/issues/426) concat of lines ([34beee3](https://github.com/bassamsdata/codecompanion.nvim/commit/34beee3a1f5e97cde61bd906afa9ddd534aeb88c))
* **inline:** [#516](https://github.com/bassamsdata/codecompanion.nvim/issues/516) switching adapters via `vim.g.codecompanion_adapter` ([0d91c08](https://github.com/bassamsdata/codecompanion.nvim/commit/0d91c086b30da050aa0a95dd9e69d16d9d88c587))
* **inline:** [#531](https://github.com/bassamsdata/codecompanion.nvim/issues/531) inline edits in c++ buffers ([73e8ea5](https://github.com/bassamsdata/codecompanion.nvim/commit/73e8ea561e81cce3b9c75d825b8294e0a82fc4e9))
* **inline:** [#613](https://github.com/bassamsdata/codecompanion.nvim/issues/613) negative column indexing ([977a521](https://github.com/bassamsdata/codecompanion.nvim/commit/977a521d1a3780d2278d1f175e37ca439b10a372))
* **inline:** [#688](https://github.com/bassamsdata/codecompanion.nvim/issues/688) end_col out of range ([6d2a477](https://github.com/bassamsdata/codecompanion.nvim/commit/6d2a47753d25872ceaaafe9968ed6e3d2ed06bbd))
...
* **keymaps:** closing and opening chat buffer ([91a08d7](https://github.com/bassamsdata/codecompanion.nvim/commit/91a08d76d47e16f3779545b1f4267a1eb0be1cb1))
* **keymaps:** completion menu is now `&lt;c-_&gt;` ([24f296b](https://github.com/bassamsdata/codecompanion.nvim/commit/24f296bd2382bc9f50d387b5ac849410d6c2d491))
...
* mini.pick as action_palette provider ([adeb7c4](https://github.com/bassamsdata/codecompanion.nvim/commit/adeb7c42fb7fb1187c64773a46d5bfee8f85dacf))
* OpenAI-compatible adapter ([#446](https://github.com/bassamsdata/codecompanion.nvim/issues/446)) ([3bfc575](https://github.com/bassamsdata/codecompanion.nvim/commit/3bfc575dd69e43cb1b2d01868f1689d024d3bbe4))
* **openai:** [#458](https://github.com/bassamsdata/codecompanion.nvim/issues/458) handle models being a function ([041193b](https://github.com/bassamsdata/codecompanion.nvim/commit/041193b1b238d7b4980847a24c19c74dcf080029))
* **openai:** [#619](https://github.com/bassamsdata/codecompanion.nvim/issues/619) o1 streaming ([83786d8](https://github.com/bassamsdata/codecompanion.nvim/commit/83786d878ebf46b50ae0a3717ad033934a80a390))
* **openai:** [#619](https://github.com/bassamsdata/codecompanion.nvim/issues/619) o1 streaming ([8bfb496](https://github.com/bassamsdata/codecompanion.nvim/commit/8bfb49633b6cd9194807856636b6b63047a06ac4))
* **openai:** support streaming in o1 models ([7c77a82](https://github.com/bassamsdata/codecompanion.nvim/commit/7c77a82b1c726734c6b6022b3f4b657660e37b57))
* opening existing chats from the action palette ([59823c2](https://github.com/bassamsdata/codecompanion.nvim/commit/59823c232da7cbbc8a5fde5edbbf32578bd653b4))
* **slash_cmd:** improve symbols notifcations ([e6b36b4](https://github.com/bassamsdata/codecompanion.nvim/commit/e6b36b4448cb12215fb74372ce9868f61e046bea))
* **slash_cmds:** `file` slash command will show hidden files with telescope ([39c7ca0](https://github.com/bassamsdata/codecompanion.nvim/commit/39c7ca07918999fa5daf8ef344a4490befa56858))
...
* **slash_commands:** [#408](https://github.com/bassamsdata/codecompanion.nvim/issues/408) no symbols found in file ([aececa0](https://github.com/bassamsdata/codecompanion.nvim/commit/aececa030a05ad86614df3fcb0fae0c40c7bac13))
* **slash_commands:** [#515](https://github.com/bassamsdata/codecompanion.nvim/issues/515) help tags line limit can be customised ([e1b9876](https://github.com/bassamsdata/codecompanion.nvim/commit/e1b9876641e4ea0fa80f78339c260b16b729a21f))
...
* **slash_commands:** fetch doesn't error on no input ([be9e36c](https://github.com/bassamsdata/codecompanion.nvim/commit/be9e36c217f15ff53b06c9eb2ba7c42de026dc70))
* **slash_commands:** handle no content in `terminal` slash command ([aae2085](https://github.com/bassamsdata/codecompanion.nvim/commit/aae208550ade2d1cbcfaada2c72aeeee83b989b0))
* **slash_commands:** prompt library now works with blink.cmp ([1027f47](https://github.com/bassamsdata/codecompanion.nvim/commit/1027f47c6c583a6b6592ae60a8008d780517792a))
...
* **slash_commands:** telescope selection ([6184bd4](https://github.com/bassamsdata/codecompanion.nvim/commit/6184bd4e60d4f301cc5f47416a9a90731eb7f8fb))
* **slash_command:** stop double wrapping output from `fetch` ([c53a917](https://github.com/bassamsdata/codecompanion.nvim/commit/c53a917803888458ba7955e52870353345c9c48c))
...
* **tools:** [#467](https://github.com/bassamsdata/codecompanion.nvim/issues/467) reading of files on disk ([034ed9e](https://github.com/bassamsdata/codecompanion.nvim/commit/034ed9eec8f8726cc30f9854d92d6f608e399717))
* **tools:** [#503](https://github.com/bassamsdata/codecompanion.nvim/issues/503) shell redirection ([7023e58](https://github.com/bassamsdata/codecompanion.nvim/commit/7023e58a056cb834cd3620fec6c42de37469109b))
* **tools:** add XML block formatting guidance ([#417](https://github.com/bassamsdata/codecompanion.nvim/issues/417)) ([315da62](https://github.com/bassamsdata/codecompanion.nvim/commit/315da62c789fd9053d5b17ba28bb78364d687d49))
* **tools:** better error handling ([0d8de44](https://github.com/bassamsdata/codecompanion.nvim/commit/0d8de4456c67a8867688497787d3794d5e09e751))
* **tools:** editor diff should be cleared on_exit ([b143ee0](https://github.com/bassamsdata/codecompanion.nvim/commit/b143ee0831c59fe2ad3582883c09a24f6659b7b0))
* **tools:** explictly add cwd to `plenary.job` call ([e78006d](https://github.com/bassamsdata/codecompanion.nvim/commit/e78006d5a09f0bc9ec78aab4f2a53a4d6bf40149))
* **tools:** output correctly in the chat buffer ([3a6acfb](https://github.com/bassamsdata/codecompanion.nvim/commit/3a6acfbc52989848b8264fe415380747a9af5615))
* **tools:** rejected cmd tools close properly ([50d0d25](https://github.com/bassamsdata/codecompanion.nvim/commit/50d0d2543ed3115477cfacfd80db0e029857127e))
* **tools:** remove ANSI sequences from all output ([2836849](https://github.com/bassamsdata/codecompanion.nvim/commit/2836849c6e1533fc54d06e88d52354374efc728d))
* **tools:** strip ansi from cmd output ([679a9a5](https://github.com/bassamsdata/codecompanion.nvim/commit/679a9a513f61a5d4e622c7506599cad55f35e502))
* use slash commands with `:CodeCompanion` cmd ([8cbf696](https://github.com/bassamsdata/codecompanion.nvim/commit/8cbf6960960bf386d85badad99152bf021554986))
* **utils:** [#488](https://github.com/bassamsdata/codecompanion.nvim/issues/488) fix edge cases in visual selection ([84a8e89](https://github.com/bassamsdata/codecompanion.nvim/commit/84a8e8962e9ae20b8357d813dee1ea44a8079605))
* **utils:** parse "boolean_scalar" fields when decoding yaml ([#635](https://github.com/bassamsdata/codecompanion.nvim/issues/635)) ([3bf8cac](https://github.com/bassamsdata/codecompanion.nvim/commit/3bf8cacd5298dfa1b103c52d8fd460b0be3b2d08))
* **utils:** visual selection range no longer uses feedkeys ([e981da2](https://github.com/bassamsdata/codecompanion.nvim/commit/e981da23ae0e900a4086e8dcbc0b6abf86b737a9))
* **workflow:** can auto_submit the first prompt ([86f96d5](https://github.com/bassamsdata/codecompanion.nvim/commit/86f96d5419915b0711afbc93d948a3312bfc25b6))
* **workflows:** wrap in `vim.schedule` for performance ([f0f6e26](https://github.com/bassamsdata/codecompanion.nvim/commit/f0f6e260a98c5ffe6ff6257227d1f429a4ecb07c))
...
* **yaml:** handle nil values in show_settings ([9b44789](https://github.com/bassamsdata/codecompanion.nvim/commit/9b447897320ee149531b6d6d8f90b25d97880666))
...
* **http:** improve resiliency of requests ([d99928b](https://github.com/bassamsdata/codecompanion.nvim/commit/d99928b5503788651b0b67bb3a577746763c7349))


### Miscellaneous Chores

* **main:** release 11.13.0 ([#687](https://github.com/bassamsdata/codecompanion.nvim/issues/687)) ([2051d27](https://github.com/bassamsdata/codecompanion.nvim/commit/2051d2707efb281b147dd883b42b23ad5bd4ed14))
* release 11.12.1 ([fe73840](https://github.com/bassamsdata/codecompanion.nvim/commit/fe73840fdc18459715d0d67a4f2685a654c17385))


### Code Refactoring

* **agents:** agents are now in `strategies.chat.agents` ([3f437a6](https://github.com/bassamsdata/codecompanion.nvim/commit/3f437a62d55ad6efe14a4af2ffdc4e474696852a))
